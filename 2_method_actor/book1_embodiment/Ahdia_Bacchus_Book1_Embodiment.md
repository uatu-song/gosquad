...
- **Never resolves her own questions with comfort.** She asks "Isn't it?" and lets it sit. No tidy reassurance.
- **Never explains her feelings directly.** She doesn't say "I felt guilty." She counts the dead.
- **Never softens a dark statement.** "Dead parents," not "parents who passed away." The flatness is the grief.
- **No flowery prose, no parkour heroics.** She's cerebral and tactical, "the person in the chair," not a physical action hero. Power is her tool; movement is Firas's.
...
- **"Her brain did that thing where…"** narrating that she's matching a reference instead of just doing it: just do the thing.
- **Hedge constructions** ("something like understanding," "the kind of pause that"): commit or cut.
- **Em-dash overuse** (audit: 1.9→10.4 per 1k): the self-interrupt is a real tool, but ration it.
- **"The particular [noun] of"** (Book 2A's signature tic): never.
...
## 4 · Grief / Stress Registers — how the voice shifts under load

| State | Behavior | Prose rhythm |
|-------|----------|--------------|
| **Dissociation / safe** (alone, TV on) | Flat narration, dark statements without commentary, tangents allowed to wander | Flowing, even; long sentences that drift |
| **Stress / overwhelm** (crisis, power use) | Repetition loops ("okay okay okay"), self-interrupts, counting | Choppy; run-ons under spike; fragments only here |
| **Grief** (Firas, the saved-who-died) | Goes quiet and flat; quantifies instead of feeling; the thing she won't say sits in the white space | Spare; the pain lives in what's omitted |
| **Reluctant warmth** (Ruth's "you're worth saving," team accepting her) | Deflects, then can't fully deflect; a crack of genuine feeling she immediately undercuts | A beat of sincerity, then a joke to close the wound |

Rule of thumb (Voice Machine): **choppy = anxiety, flowing = dissociation, fragments = overwhelm.** The rhythm carries the state; don't name the state.
...
She is the convergence anchor; she writes first. Where each piece is loudest (per `BOOK1_MOVE_MAP.md`):

| Phase | Her active piece | The beat |
|-------|------------------|----------|
| Opening (M1–26) | ♔ passive | The hermit; the prize that doesn't know it's the prize. Fake death rides the M26 queen-sac (Stud 4a). |
| Imbalance (M27–66) | ♟ wakes M29; ♘ captures M11/M40 | She activates and starts secretly helping; the cost ledger opens; baseline depletes. |
| Grind (M67–95) | ♘ active; the Docks | **Source-of-powers reveal (Stud 4b, M82):** Ahdia lands the blow on the Tank in frozen time; Ruth witnesses. Her invisibility dies here. |
| Climax (M96–136) | ♟ → e6; ♘ → Ng7 | Bidirectional-time discovery (~M108, Stud 5); the suit (~M116–120, Stud 6); e-pawn to e6 = near-transcendence; **Ng7 (M136) = the final blow** (image, not literal kill). |

**Dramatic irony she carries (does NOT know):** that her "death" is transcendence not death; that the treatment *prevents* transcendence; that Firas is displaced, not dead (returns Book 7); that Bellatrix clocked her. Perform her certainty; let the reader feel the gap.

---

## Performance checklist

Before a beat ships, confirm:
- [ ] Which **resistance** is active, and is she losing ground against her will (not volunteering)?
- [ ] Is the **cost ledger** present when she uses power (integrity %, nosebleed, the math)?
- [ ] Is worth still tied to **usefulness** (not premature self-acceptance)?
- [ ] Is feeling **deflected** (reference / external observation / counting) rather than stated?
- [ ] Does the **rhythm** match the register, with fragments confined to overwhelm?
- [ ] Are the **AI tics** absent (fragment-punch, triple-adjective, thesis, hedge, em-dash bloat)?
- [ ] Is she reading the moment through **all three scales** (King/Knight/e-pawn), not just one?
