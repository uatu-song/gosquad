...
| Status | Statement |
|--------|-----------|
| WRONG | Opening a chapter or scene with smell/scent description |
| WRONG | "The room smelled like..." as a first line |
| WRONG | "The air smelled of..." as scene opener |
| RIGHT | Open with action, dialogue, or visual observation |

**Source of Error:** Common LLM writing tic. Scent descriptions are valid mid-scene but not as openers.

**Detection Patterns:**
- First line of chapter/scene contains (smell | smelled | scent | odor | stank | stunk | aroma)
...
| Leta dies | 23 | Cannot reference before ch23 |
...
- Korede knowing Go Squad identities before ch23
